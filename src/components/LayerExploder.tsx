    ...
    <div className="bg-[#FFFFFF] p-6 sm:p-8 rounded-3xl paper-elevation-2 space-y-6">
      <div className="flex items-center justify-between pb-4 border-b border-[#1A1A1A]/10">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-2xl bg-[#0047AB] text-white flex items-center justify-center paper-elevation-1">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all paper-btn ${
            lighting.explodedView
              ? 'bg-[#E63946] text-white'
              : 'bg-[#0047AB] text-white'
          }`}
        >
          {lighting.explodedView ? 'Vue 2D' : 'Activer 3D'}
        </button>
      </div>
      ...
      {lighting.explodedView ? (
        <div className="space-y-5 animate-fadeIn">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center text-xs font-bold text-[#1A1A1A]">
              ...
              <span className="font-mono text-[#0047AB] font-bold">{lighting.explodeDepth}px</span>
            </div>
            <input
              type="range"
              min="15"
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center text-xs font-bold text-[#1A1A1A]">
              ...
              <span className="font-mono text-[#E63946] font-bold">{lighting.tiltX}°</span>
            </div>
            <input
              type="range"
              min="-40"
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center text-xs font-bold text-[#1A1A1A]">
              ...
              <span className="font-mono text-[#06A77D] font-bold">{lighting.tiltY}°</span>
            </div>
            <input
              type="range"
              min="-60"
          ...
          <div className="pt-2 border-t border-[#1A1A1A]/10">
            <span className="text-[11px] font-bold text-[#1A1A1A]/70 uppercase tracking-wider block mb-2">
              Angles de vue prédéfinis :
            </span>
            <div className="grid grid-cols-3 gap-2">
              <button
                onClick={() => onChangeLighting({ tiltX: 20, tiltY: -30, explodeDepth: 40 })}
                className="px-3 py-2 rounded-xl text-xs font-bold bg-[#FFFFFF] hover:bg-[#0047AB] hover:text-white text-[#1A1A1A] paper-elevation-1 transition-all"
              >
                Isométrique
              </button>
              <button
        ...
        <div className="p-5 rounded-2xl bg-[#FFFFFF] paper-elevation-1 text-center text-xs text-[#1A1A1A]/70 leading-relaxed font-medium">
